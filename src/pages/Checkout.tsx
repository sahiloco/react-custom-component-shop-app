...
const Checkout = () => {
  return (
    <div className={styles.checkout}>
      <Navigation3
        black="/black2@2x.png"
        shoppingCart="pending_I106:2998;1:2578;305:2042;316:1608"
        blackIconFlex="unset"
        blackIconAlignSelf="stretch"
        iconTop="unset"
        iconPosition="unset"
        frameDivWidth="unset"
        fourthFlex="unset"
        fourthWidth="23px"
        categoryPadding="16px 20px"
        categoryGap="443px"
        customerSupportTextDecoration="unset"
      />
      <FrameComponent3 />
      <section className={styles.billingInnerContainerWrapper}>
        <form className={styles.billingInnerContainer}>
          <FrameComponent />
          <OrderSummery />
        </form>
      </section>
